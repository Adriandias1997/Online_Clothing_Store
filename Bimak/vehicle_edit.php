...
<head>
    ...
    <!-- Title Page-->
    <title>Vehicle Update Details</title>
	<link rel="icon" type="image/png" href="images/admin/cartoon-car-png-1.png" />
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="overview-wrap">
                                   <center> <h1><i class="fas fa-list-alt"></i> &nbsp Vehicle Update Details </h1> </center>
                                </div>
                                <hr><br>                                
                            </div>
                        </div>
