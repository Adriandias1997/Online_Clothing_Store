...
<head>
	...
	<link rel="icon" type="image/png" href="images/admin/png-customer-910x1128-sell-products-910.png" />
                                    ...
                                    <center>
                                        <form action='admin_customer_update.php' method='post' enctype='multipart/form-data' class='form-horizontal' >
                                            ...
                                            <div class='row form-group'>
                                                ...
                                                <div class='col-12 col-md-9'>
                                                    <input type='password' id='text-input'  name='password' value='$password' class='form-control'>
                                                  </div>
                                            </div>
