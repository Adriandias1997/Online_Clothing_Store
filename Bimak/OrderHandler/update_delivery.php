...
<script type="text/javascript" src="js/jquery-3.4.1.min.js"></script>
    ...
    <!-- Title Page-->
    <title>Update Delivery Home Details</title>
	<link rel="icon" type="image/png" href="../images/admin/6958544_preview.png" />
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="update_success.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                            ...
                                            <input type="hidden" id="Regno" name="oid"  class="form-control" value = "<?php echo "$oid";?>" disabled>
