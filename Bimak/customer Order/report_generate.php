...
<head>
	...
	<link rel="icon" type="image/png" href="../images/admin/60-607394_benefits-of-an-employee-handbook-employee-clipart-png.png" />
...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <a href="#">
                    <img src="../images/icon/logo.png" alt="Bimak" />
                </a>
            </div>
                                                    ...
                                                    <div class="overview-item overview-item--c1">
                                                        <div class="overview__inner">
                                                            <div class="overview-box clearfix">
                                                                ...
                                                                <div class="text">
                                                                    <h3> <span>Total Earnings:</span> </h3>
                                                    ...
                                                    <div class="overview-item overview-item--c1">
                                                        <div class="overview__inner">
                                                            <div class="overview-box clearfix">
                                                                ...
                                                                <div class="text">
                                                                    <h3> <span>  Total order Items :</span> </h3>
                                                    ...
                                                    <div class="overview-item overview-item--c1">
                                                        <div class="overview__inner">
                                                            <div class="overview-box clearfix">
                                                                ...
                                                                <div class="text">
                                                                    <h3> <span>  Total  Qty of order items : </span> </h3>
                                                    ...
                                                    <div class="overview-item overview-item--c1">
                                                        <div class="overview__inner">
                                                            <div class="overview-box clearfix">
                                                                ...
                                                                <div class="text">
                                                                    <h3> <span>  Total of Cancel orders : </span> </h3>

                                                                    <h2>  <?php echo $count_cancel; ?></h2>

                                                                    <h3> <span>  Total of Cancel orders percentage : </span> </h3>
                                                    ...
                                                    <div class="overview-item overview-item--c1">
                                                        <div class="overview__inner">
                                                            <div class="overview-box clearfix">
                                                                ...
                                                                <div class="text">
                                                                    <h3> <span>  Average of Sales: </span> </h3>
